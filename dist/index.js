...
var z=require('@stdlib/blas-base-assert-is-layout/dist'),A=require('@stdlib/ndarray-base-assert-is-column-major-string/dist'),B=require('@stdlib/strided-base-stride2offset/dist'),R=require('@stdlib/math-base-special-pow/dist'),E=require('@stdlib/math-base-special-fast-max/dist'),p=require('@stdlib/error-tools-fmtprodmsg/dist'),G=j();function H(e,r,n,l,q,u,a){var t,o;if(!z(e))throw new TypeError(p('2erFx',e));if(A(e)){if(a<E(1,R(r,n)))throw new RangeError(p('2erGR',R(r,n),a));t=1,o=a}else{if(a<E(1,n))throw new RangeError(p('2erGR',n,a));t=a,o=1}return G(r,n,l,q,B(r,q),u,t,o,0)}P.exports=H
